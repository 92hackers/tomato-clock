...
describe('SettingsStore', () => {
  ...
  describe('Timer Settings', () => {
    it('should update work duration', () => {
      ...
      // 其他设置应该保持不变
      expect(state.timers.shortBreakDuration).toBe(
        DEFAULT_SETTINGS.timers.shortBreakDuration
      );
      expect(state.timers.longBreakDuration).toBe(
        DEFAULT_SETTINGS.timers.longBreakDuration
      );
    });
  ...
  describe('Notification Settings', () => {
    it('should update notification settings', () => {
      ...
      expect(state.notifications.breakReminder).toBe(
        DEFAULT_SETTINGS.notifications.breakReminder
      );
    });
  });
  ...
  describe('Reset Settings', () => {
    it('should reset all settings to defaults', () => {
      const { updateTimerSettings, resetToDefaults } =
